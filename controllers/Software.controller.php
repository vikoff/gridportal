...
class SoftwareController extends Controller{
	...
	public function display_list($params = array()){
		...
		$collection = new SoftwareCollection();
		$variables = array(
	...
	public function display_view($params = array()){
		...
		$instanceId = getVar($params[0], 0, 'int');
			...
			$variables = Software::Load($instanceId)->GetAllFieldsPrepared();
			FrontendViewer::get()
				->setTitle('Детально')
	...
	public function admin_display_new($params = array()){
		...
		$variables = array_merge($_POST, array(
			'instanceId' => 0,
			'pageTitle'  => $pageTitle,
			'validation' => Software::Create()->getValidator()->getJsRules(),
	...
	public function admin_display_edit($params = array()){
		...
		$instanceId = getVar($params[0], 0 ,'int');
		$instance = Software::Load($instanceId);
	...
	public function action_save($params = array()){
		...
		$instance = new Software($instanceId);
	...
	public function action_delete($params = array()){
		...
		$this->setRedirectUrl('admin/content/software/list');
