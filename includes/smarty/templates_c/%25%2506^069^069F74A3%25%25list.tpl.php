<?php /* Smarty version 2.6.26, created on 2011-09-03 21:09:07
...
?>
 ...
 <?php if ((isset($this->_tpl_vars['item']['is_test']) ? $this->_tpl_vars['item']['is_test'] : '')): ?><sup>(тестовая)</sup><?php endif; ?></td>
		<td><?php if ((isset($this->_tpl_vars['item']['is_gridjob_loaded']) ? $this->_tpl_vars['item']['is_gridjob_loaded'] : '')): ?><span class="green">есть</span><?php else: ?><span class="red">нет</span><?php endif; ?></td>
		<td><?php echo (isset($this->_tpl_vars['item']['state_title']) ? $this->_tpl_vars['item']['state_title'] : ''); ?>
</td>
