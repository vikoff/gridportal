-- 
-- START MYSQL DATABASE DUMP
-- dump created with Vik-Off-Dumper
-- 
-- Host: thei.org.ua
-- Database : gridjobs
-- Encoding : utf8
-- Generation Time: 23 Sep 2011 19:37:43
...
INSERT INTO page (`id`, `title`, `alias`, `body`, `author`, `published`, `locked`, `meta_description`, `meta_keywords`, `modif_date`, `create_date`) VALUES 
...
INSERT INTO pages (`id`, `alias`, `type`, `author`, `published`, `locked`, `modif_date`, `create_date`) VALUES 
	('1','main','1','1','1','0','1316505601','1316504239'),
	('2','virtual-organizations','1','2','1','0','1316546628','1316546628'),
	('3','projects','1','2','1','0','1316547171','1316547171');


-- --------------------------------------------------------------------------------

--
-- TABLE pages_en STRUCTURE
--
...
INSERT INTO pages_en (`page_id`, `title`, `body`, `meta_description`, `meta_keywords`) VALUES 
...
INSERT INTO pages_ru (`page_id`, `title`, `body`, `meta_description`, `meta_keywords`) VALUES 
...
INSERT INTO pages_ua (`page_id`, `title`, `body`, `meta_description`, `meta_keywords`) VALUES 
	('1','','','',''),
	('2',NULL,NULL,NULL,NULL),
	('3',NULL,NULL,NULL,NULL);
...
--
-- TABLE project_allowed_voms STRUCTURE
--
...
--
-- TABLE project_allowed_voms DUMP
--

INSERT INTO project_allowed_voms (`project_id`, `voms_id`) VALUES 
	('1','3'),
	('4','3'),
	('4','4'),
	('4','5');
...
INSERT INTO software (`id`, `name`, `project_id`) VALUES 
	('1','FDS симулятор','1'),
	('2','Gromax','2');
...
--
-- TABLE task_states DUMP
--

INSERT INTO task_states (`id`, `name`, `title`) VALUES 
...
CREATE TABLE `tasks` (
  ...
  `name` varchar(255) collate utf8_bin default NULL,
  `jobid` varchar(255) collate utf8_bin NOT NULL,
  `xrsl_command` text collate utf8_bin,
  `state` smallint(6) default NULL,
  `date` int(10) unsigned default NULL,
  `is_test` char(1) collate utf8_bin default NULL,
  `is_gridjob_loaded` char(1) collate utf8_bin NOT NULL default '0',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO tasks (`id`, `uid`, `name`, `jobid`, `xrsl_command`, `state`, `date`, `is_test`, `is_gridjob_loaded`) VALUES 
	...
	('7','2','1','',NULL,'10','1316605845','1','1'),
	('8','2','1111','',NULL,'10','1316611164','0','0'),
	('9','2','TEST','gsiftp://uagrid.org.ua:2811/jobs/1428113167050101690976633','a:9:{s:10:\"executable\";s:12:\"\"/bin/sleep\"\";s:9:\"arguments\";s:6:\"\"2850\"\";s:7:\" stdout\";s:15:\"\"CrimeaEco.txt\"\";s:7:\" stderr\";s:15:\"\"CrimeaEco.err\"\";s:12:\" outputFiles\";s:40:\"(\"CrimeaEco.txt\" \"\")(\"CrimeaEco.err\" \"\")\";s:6:\" gmlog\";s:10:\"\"gridlog\" \";s:8:\" jobname\";s:27:\"\"Test job on CrimeaEco VO\" \";s:8:\" cputime\";s:5:\"2850 \";s:6:\" count\";s:2:\"1 \";}','6','1316703634','1','1'),
	('10','2','ololo','',NULL,'10','1316794119','0','0');


-- --------------------------------------------------------------------------------

--
-- TABLE user_accepted_voms STRUCTURE
--
...
--
-- TABLE user_accepted_voms DUMP
--

INSERT INTO user_accepted_voms (`uid`, `voms_id`) VALUES 
	('2','3'),
	('2','4'),
	('2','6'),
	('4','3');
...
--
-- TABLE user_allowed_projects STRUCTURE
--
...
--
-- TABLE user_allowed_projects DUMP
--

INSERT INTO user_allowed_projects (`uid`, `project_id`, `default_vo`) VALUES 
	('1','1',NULL),
	('1','2',NULL),
	('1','4',NULL),
	('2','4','3'),
...
--
-- TABLE user_allowed_software STRUCTURE
--
...
--
-- TABLE user_allowed_software DUMP
--

INSERT INTO user_allowed_software (`uid`, `software_id`) VALUES 
	('2','1'),
	('2','2'),
	('4','1');
...
--
-- TABLE user_statistics STRUCTURE
--
...
CREATE TABLE `user_statistics` (
  ...
  `request_urls` text collate utf8_bin,
  `user_ip` varchar(255) collate utf8_bin default NULL,
  `referer` varchar(255) collate utf8_bin default NULL,
  `user_agent_raw` varchar(255) collate utf8_bin default NULL,
  `has_js` tinyint(1) default NULL,
  `browser_name` varchar(50) collate utf8_bin default NULL,
  `browser_version` varchar(50) collate utf8_bin default NULL,
...
CREATE TABLE `users` (
  ...
  `dn` varchar(255) collate utf8_bin default NULL,
  `dn_cn` varchar(255) collate utf8_bin default NULL,
...
INSERT INTO users (`id`, `login`, `password`, `dn`, `dn_cn`, `surname`, `name`, `level`, `regdate`, `profile`) VALUES 
...
INSERT INTO voms (`id`, `name`, `url`) VALUES 
