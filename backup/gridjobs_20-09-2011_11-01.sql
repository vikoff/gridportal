...
-- Database : gridjobs
-- Encoding : utf8
-- Generation Time: 20 Sep 2011 11:01:01
...
INSERT INTO pages (`id`, `alias`, `author`, `published`, `locked`, `modif_date`, `create_date`) VALUES 
...
INSERT INTO tasks (`id`, `uid`, `name`, `jobid`, `xrsl_command`, `state`, `date`, `is_test`, `is_gridjob_loaded`) VALUES 
	...
	('60','2','forestfire1','','','1','1311530693','0','0'),
	('61','2','TEST','','','1','1312741161','0','0'),
	...
	('70','1','123','','','1','1315078782','0','0'),
	('71','1','1','','','1','1315084705','0','0'),
...
INSERT INTO user_allowed_projects (`uid`, `project_id`) VALUES 
	('1','1'),
	('1','2'),
	('1','4');
...
INSERT INTO users (`id`, `login`, `password`, `dn`, `dn_cn`, `surname`, `name`, `level`, `regdate`, `profile`) VALUES 
	...
	('2','','','/DC=org/DC=ugrid/O=people/O=UGRID/CN=Vadim Khramov','Vadim Khramov','Khramov','Vadim','50','1311091980',''),
	('4','','','/DC=org/DC=ugrid/O=people/O=THEI/CN=Dmitriy Mickiy','Dmitriy Mickiy','Mickiy','Dmitriy','5','1311121485',''),
